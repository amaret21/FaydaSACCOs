...
<head>
    ...
    <title>Member Dashboard - Fayda SACCO</title>
...
<body>
    ...
    <div class="top-bar bg-primary text-white py-2">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <marquee>Welcome to Fayda SACCO Member Dashboard</marquee>
                </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="../index.html">
                    ...
                    <small class="logo-slogan">Member Dashboard</small>
                </a>
            ...
            <div class="col-md-4 mb-3">
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        ...
                        <a href="deposits.php" class="text-white">View transaction history</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        ...
                        <a href="shares.php" class="text-white">View shares details</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card bg-info text-white">
                    <div class="card-body">
                        ...
                        <a href="shares.php" class="text-white">Make a payment</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="make_deposit.php" class="btn btn-primary">Make a Deposit</a>
                            <a href="apply_loan.php" class="btn btn-success">Apply for Loan</a>
                            <a href="buy_shares.php" class="btn btn-info">Buy More Shares</a>
