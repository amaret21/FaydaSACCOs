    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($amount <= 0) {
            ...
            if ($transactionProof['error'] === UPLOAD_ERR_OK) {
                ...
                $fileName = 'deposit_' . $member['member_id'] . '_' . time() . '.' . $fileExt;
            ...
            if (!$error) {
                ...
                $success = "Deposit submitted successfully! It will be processed within 24 hours.";
            }
        }
    }
...
<head>
    ...
    <title>Make Deposit - Fayda SACCO</title>
...
<body>
    ...
    <div class="top-bar bg-primary text-white py-2">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <marquee>Welcome to Fayda SACCO - Make a Deposit</marquee>
                </div>
                    ...
                    <div class="card-body">
                        <?php if ($success): ?>
                            ...
                            <div class="text-center">
                                <a href="deposits.php" class="btn btn-primary">View My Deposits</a>
                                <a href="make_deposit.php" class="btn btn-outline-primary">Make Another Deposit</a>
                            </div>
                        <?php else: ?>
                            <?php if ($error): ?>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <p class="mb-0">Deposits are processed within 24 hours on business days.</p>
                                </div>
